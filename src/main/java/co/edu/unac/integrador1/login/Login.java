...
package co.edu.unac.integrador1.login;  // Asegúrate de que sea consistente
...
import co.edu.unac.integrador1.votacion.VotingFrame;
...
public class Login extends javax.swing.JFrame {
    public Login() {
        ...
        setVisible(true); // Asegura que la ventana es visible
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      // 1. Captura los datos ingresados en los campos de texto.
        String nombreUsuario = jTextField3.getText().trim();
        String idTexto = jTextField1.getText().trim();
        String contrasena = new String(jPasswordField1.getPassword());
    
        // 2. Convierte el ID a número (ya que en tu código el ID es un Long).
        long idLong;
        try {
            idLong = Long.parseLong(idTexto);
            ...
            return; // Se sale si el ID no es un número válido.
        }
    
        // 3. Verificar las credenciales usando el método de Administrador.
        boolean credencialesValidas = Administrador.verificarUsuario(idLong, contrasena);
    
        if (credencialesValidas) {
            // 4. Si las credenciales son correctas, muestra un mensaje de éxito.
            javax.swing.JOptionPane.showMessageDialog(
                this, 
                "Inicio de sesión exitoso para ID: " + idLong, 
                "Bienvenido", 
                javax.swing.JOptionPane.INFORMATION_MESSAGE
            );
            // 5. Abre la ventana de votación.
            VotingFrame votacion = new VotingFrame(idLong);
            votacion.setVisible(true);
            // 6. Cierra la ventana de Login.
            this.dispose();
        } else {
            // 7. Si las credenciales son incorrectas, muestra un mensaje de error.
            javax.swing.JOptionPane.showMessageDialog(
                this, 
    ...
    private void jPasswordField1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPasswordField1MousePressed
     ...
     public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(() -> new Login().setVisible(true)); // Usa Login en lugar de LoginFrame
    }
